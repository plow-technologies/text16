...
import Data.Text16.Encoding.Error (UnicodeException)
import Data.Text16.Internal.Encoding.Utf8 (ord2, ord3, ord4)
...
decodeLL :: BL.ByteString -> TL.Text16
decodeLL = EL.decodeUtf8With E.lenientDecode

decodeL :: B.ByteString -> T.Text16
