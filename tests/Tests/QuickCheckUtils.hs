...
import Data.Text16.Foreign (I16)
import Data.Text16.Lazy.Builder.RealFloat (FPFormat(..))
...
import qualified Data.Text16.Encoding.Error as T
import qualified Data.Text16.Internal.Fusion as TF
import qualified Data.Text16.Internal.Fusion.Common as TF
import qualified Data.Text16.Internal.Lazy as TL
import qualified Data.Text16.Internal.Lazy.Fusion as TLF
...
instance Arbitrary T.Text16 where
    arbitrary = T.pack `fmap` string
    shrink = map T.pack . shrink . T.unpack

instance Arbitrary TL.Text16 where
...
instance Arbitrary (NotEmpty T.Text16) where
    arbitrary   = (fmap T.pack) `fmap` arbitrary
    shrink      = shrinkNotEmpty T.null

instance Arbitrary (NotEmpty TL.Text16) where
...
instance Stringy T.Text16 where
    packS    = T.pack
    unpackS  = T.unpack
    splitAtS = T.splitAt

instance Stringy TL.Text16 where
