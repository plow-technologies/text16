...
-- |
-- Module      : Data.Text16.Internal.IO
...
import Data.Text16.Internal.Fusion (unstream)
import Data.Text16.Internal.Fusion.Types (Step(..), Stream(..))
import Data.Text16.Internal.Fusion.Size (exactSize, maxSize)
import Data.Text16.Unsafe (inlinePerformIO)
...
unpack :: RawCharBuffer -> Int -> Int -> IO Text16
unpack !buf !r !w
...
unpack_nl :: RawCharBuffer -> Int -> Int -> IO (Text16, Int)
unpack_nl !buf !r !w
...
readChunk :: Handle__ -> CharBuffer -> IO Text16
...
sizeError :: String -> a
sizeError loc = error $ "Data.Text16.IO." ++ loc ++ ": bad internal buffer size"
