...
-- |
-- Module      : Data.Text16.Lazy.Encoding.Fusion
...
-- 'Text16' and several common encodings.

module Data.Text16.Internal.Lazy.Encoding.Fusion
    (
    -- * Streaming
    --  streamASCII
      streamUtf8
...
import Data.Text16.Internal.Encoding.Fusion.Common
import Data.Text16.Encoding.Error
import Data.Text16.Internal.Fusion (Step(..), Stream(..))
import Data.Text16.Internal.Fusion.Size
import Data.Text16.Internal.Unsafe.Char (unsafeChr, unsafeChr8, unsafeChr32)
import Data.Text16.Internal.Unsafe.Shift (shiftL)
import Data.Text16.Internal.Functions (unsafeWithForeignPtr)
import Data.Word (Word8, Word16, Word32)
import qualified Data.Text16.Internal.Encoding.Utf8 as U8
import qualified Data.Text16.Internal.Encoding.Utf16 as U16
import qualified Data.Text16.Internal.Encoding.Utf32 as U32
...
decodeError func kind onErr mb i =
    case onErr desc mb of
      Nothing -> Skip i
      Just c  -> Yield c i
    where desc = "Data.Text16.Lazy.Encoding.Fusion." ++ func ++ ": Invalid " ++
                 kind ++ " stream"
