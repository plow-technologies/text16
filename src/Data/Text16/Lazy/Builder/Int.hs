...
-- Module:      Data.Text16.Lazy.Builder.Int
...
import Data.Text16.Internal.Builder.Int.Digits (digits)
import Data.Text16.Array
...
hexErrMsg :: String
hexErrMsg = "Data.Text16.Lazy.Builder.Int.hexadecimal: applied to negative number"
