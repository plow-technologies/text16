...
-- |
-- Module:    Data.Text16.Lazy.Builder.RealFloat
...
import Data.Text16.Internal.Builder.Functions ((<>), i2d)
import Data.Text16.Lazy.Builder.Int (decimal)
import Data.Text16.Internal.Builder.RealFloat.Functions (roundTo)
import Data.Text16.Lazy.Builder
  ...
  doFmt format (is, e) =
    ...
    case format of
     ...
     Exponent ->
      case decs of
       ...
       Just dec ->
        ...
        case is of
         [0] -> "0." <> fromText16 (T.replicate dec' "0") <> "e0"
         _ ->
     ...
     Fixed ->
      ...
      case decs of
       Nothing
          | e <= 0    -> "0." <> fromText16 (T.replicate (-e) "0") <> fromString ds
          | otherwise ->
             let
