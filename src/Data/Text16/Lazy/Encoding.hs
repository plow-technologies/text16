...
-- |
-- Module      : Data.Text16.Lazy.Encoding
...
--
-- Functions for converting lazy 'Text16' values to and from lazy
...
import Data.Text16.Internal.Lazy (Text16(..), chunk, empty, foldrChunks)
...
import qualified Data.Text16.Encoding as TE
import qualified Data.Text16.Internal.Lazy.Encoding.Fusion as E
import qualified Data.Text16.Internal.Lazy.Fusion as F
...
-- encoded text.
decodeASCII :: B.ByteString -> Text16
decodeASCII = decodeUtf8
{-# DEPRECATED decodeASCII "Use decodeUtf8 instead" #-}

-- | Decode a 'ByteString' containing Latin-1 (aka ISO-8859-1) encoded text.
decodeLatin1 :: B.ByteString -> Text16
decodeLatin1 = foldr (chunk . TE.decodeLatin1) empty . B.toChunks

-- | Decode a 'ByteString' containing UTF-8 encoded text.
decodeUtf8With :: OnDecodeError -> B.ByteString -> Text16
        ...
        let !t = T.pack (skipBytes l)
            skipBytes = S.foldr (\x s' ->
                  case onErr desc (Just x) of
                    ...
                    Nothing -> s') [] in
        Chunk t Empty
    desc = "Data.Text16.Lazy.Encoding.decodeUtf8With: Invalid UTF-8 stream"
...
-- 'decodeUtf8With'.
decodeUtf8 :: B.ByteString -> Text16
...
decodeUtf8' :: B.ByteString -> Either UnicodeException Text16
...
encodeUtf8 :: Text16 -> B.ByteString
...
decodeUtf16LEWith :: OnDecodeError -> B.ByteString -> Text16
...
decodeUtf16LE :: B.ByteString -> Text16
decodeUtf16LE = decodeUtf16LEWith strictDecode
{-# INLINE decodeUtf16LE #-}

-- | Decode text from big endian UTF-16 encoding.
decodeUtf16BEWith :: OnDecodeError -> B.ByteString -> Text16
...
decodeUtf32LE :: B.ByteString -> Text16
decodeUtf32LE = decodeUtf32LEWith strictDecode
{-# INLINE decodeUtf32LE #-}

-- | Decode text from big endian UTF-32 encoding.
decodeUtf32BEWith :: OnDecodeError -> B.ByteString -> Text16
...
decodeUtf32BE :: B.ByteString -> Text16
decodeUtf32BE = decodeUtf32BEWith strictDecode
{-# INLINE decodeUtf32BE #-}

-- | Encode text using little endian UTF-32 encoding.
encodeUtf32LE :: Text16 -> B.ByteString
encodeUtf32LE txt = B.fromChunks (foldrChunks ((:) . TE.encodeUtf32LE) [] txt)
{-# INLINE encodeUtf32LE #-}

-- | Encode text using big endian UTF-32 encoding.
encodeUtf32BE :: Text16 -> B.ByteString
