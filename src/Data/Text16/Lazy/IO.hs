...
import Data.Text16.Lazy (Text16)
...
import Data.Text16.Internal.Lazy (chunk, empty)
...
lazyReadBuffered :: Handle -> Handle__ -> IO (Handle__, Text16)
...
-- > import Data.Text16.Lazy (Text16)
-- > import Data.Text16.Lazy.Encoding (encodeUtf16)
-- >
