...
--
-- Functions for converting 'Text16' values to and from 'ByteString',
...
module Data.Text16.Encoding
    (
    -- * Decoding ByteStrings to Text16
    -- $strict
      decodeASCII
    , decodeLatin1
    , decodeUtf8
    ...
    -- * Encoding Text16 to ByteStrings
    , encodeUtf8
    , encodeUtf16LE
    , encodeUtf16BE
    , encodeUtf32LE
    ...
    -- * Encoding Text16 using ByteString Builders
    , encodeUtf8Builder
...
import Data.Text16.Encoding.Error (OnDecodeError, UnicodeException, strictDecode)
import Data.Text16.Internal (Text16(..), safe, text)
import Data.Text16.Internal.Functions
import Data.Text16.Internal.Private (runText16)
import Data.Text16.Internal.Unsafe.Char (ord, unsafeWrite)
import Data.Text16.Internal.Unsafe.Shift (shiftR)
import Data.Text16.Show ()
import Data.Text16.Unsafe (unsafeDupablePerformIO)
...
import qualified Data.Text16.Internal.Encoding.Fusion as E
import qualified Data.Text16.Internal.Encoding.Utf16 as U16
import qualified Data.Text16.Internal.Fusion as F
import Data.Text16.Internal.ByteStringCompat
#if defined(ASSERTS)
...
--  @Data.Text16.pack . Data.ByteString.Char8.unpack@
decodeLatin1 ::
#if defined(ASSERTS)
  HasCallStack =>
#endif
...
decodeUtf8With ::
  ...
  HasCallStack =>
#endif
  OnDecodeError -> ByteString -> Text16
decodeUtf8With onErr bs = withBS bs aux
 where
  aux fp len = runText16 $ \done -> do
   ...
   where
    desc = "Data.Text16.Internal.Encoding.decodeUtf8: Invalid UTF-8 stream"
...
--
-- 1. The maximal prefix of 'Text16' that could be decoded from the
--    given input.
--
...
--
-- @since 1.0.0.0
data Decoding = Some Text16 ByteString (ByteString -> Decoding)
                ...
                loop curPtr = do
                  ...
                  case state of
                    ...
                    _ -> do
                      ...
                      return $ Some chunkText16 undecoded
                               (decodeChunk undecoded codepoint state)
            in loop ptr
  desc = "Data.Text16.Internal.Encoding.streamDecodeUtf8With: Invalid UTF-8 stream"
...
decodeUtf8' ::
  ...
  HasCallStack =>
#endif
  ByteString -> Either UnicodeException Text16
...
--
-- @since 1.1.0.0
encodeUtf8Builder :: Text16 -> B.Builder
...
encodeUtf8BuilderEscaped :: BP.BoundedPrim Word8 -> Text16 -> B.Builder
encodeUtf8BuilderEscaped be =
  ...
  where
    ...
    mkBuildstep (Text16 arr off len) !k =
        outerLoop off
      where
        iend = off + len
...
encodeUtf8 :: Text16 -> ByteString
encodeUtf8 (Text16 arr off len)
  | len == 0  = B.empty
...
decodeUtf16LEWith :: OnDecodeError -> ByteString -> Text16
...
decodeUtf16LE :: ByteString -> Text16
decodeUtf16LE = decodeUtf16LEWith strictDecode
{-# INLINE decodeUtf16LE #-}

-- | Decode text from big endian UTF-16 encoding.
decodeUtf16BEWith :: OnDecodeError -> ByteString -> Text16
...
decodeUtf32LE :: ByteString -> Text16
decodeUtf32LE = decodeUtf32LEWith strictDecode
{-# INLINE decodeUtf32LE #-}

-- | Decode text from big endian UTF-32 encoding.
decodeUtf32BEWith :: OnDecodeError -> ByteString -> Text16
...
decodeUtf32BE :: ByteString -> Text16
decodeUtf32BE = decodeUtf32BEWith strictDecode
{-# INLINE decodeUtf32BE #-}

-- | Encode text using little endian UTF-32 encoding.
encodeUtf32LE :: Text16 -> ByteString
encodeUtf32LE txt = E.unstream (E.restreamUtf32LE (F.stream txt))
{-# INLINE encodeUtf32LE #-}

-- | Encode text using big endian UTF-32 encoding.
encodeUtf32BE :: Text16 -> ByteString
